    ...
    try {
      await query(`
        ...
        CREATE TABLE IF NOT EXISTS duty_roster (
          ...
          duration_mins FLOAT, duty_type TEXT DEFAULT 'general', notes TEXT
        );
        ...
        CREATE TABLE IF NOT EXISTS training_records (
          id UUID PRIMARY KEY DEFAULT gen_random_uuid(), guild_id TEXT NOT NULL,
          trainee_user_id TEXT NOT NULL, trainee_username TEXT NOT NULL,
          trainer_user_id TEXT NOT NULL, trainer_username TEXT NOT NULL,
          training_type TEXT DEFAULT 'general', status TEXT DEFAULT 'pending',
          notes TEXT, passed BOOLEAN, started_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, completed_at TIMESTAMP
        );
      ...
      for (const m of migrations) {
        await query(m).catch(e => {
          if (!e.message.includes('already exists')) {
            console.warn('[DB] Migration note:', e.message.slice(0, 80));
          }
        });
      }
